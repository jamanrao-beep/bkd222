...
export default function FloatingWhatsApp() {
  return (
    <aside aria-label="WhatsApp Contact" className="fixed bottom-6 left-6 z-50 flex items-center group">
      <Link
      ...
      {/* Tooltip on Hover */}
      <div className="pointer-events-none absolute left-full ml-3 hidden sm:flex items-center opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
