...
export default function Partners() {
  return (
    <main className="min-h-screen bg-[#fafafa] text-black selection:bg-brand-gold selection:text-white flex flex-col font-sans">
      ...
      {/* Header & Hero Section */}
      <section className="relative w-full h-[50vh] min-h-[400px] flex flex-col mt-[80px]">
        {/* Background Image */}
      ...
      <section className="relative overflow-hidden bg-[#0f1115] py-20 px-8">
        ...
        <div className="max-w-7xl mx-auto flex flex-col relative z-10">
          ...
          <div>
            <Link href='/contact' className="inline-flex items-center justify-center gap-2 bg-brand-gold text-white px-8 py-3.5 font-semibold rounded hover:bg-brand-gold-hover transition-all text-sm shadow-lg shadow-brand-gold/20">
      ...
      <footer className="bg-[#0a0b0f] pt-20 pb-8 px-8 border-t border-white/5 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6 pr-0 md:pr-4 max-w-sm md:max-w-none">
