...
import {
  ...
  Crosshair, Spline, ArrowUp, BriefcaseBusiness, Phone
} from "lucide-react";
    ...
    <div className="w-full bg-[#f8f9fa] min-h-screen font-sans selection:bg-[#F7A300] selection:text-white">
      ...
      <section className="relative w-full h-[85vh] min-h-[600px] flex flex-col pt-[80px]">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-8 md:px-16 max-w-[1400px] mx-auto w-full text-white">
          ...
          <p className="text-gray-100 text-base max-w-sm leading-relaxed mb-12 font-medium">
            Prime 480 Gaj plot just 30 meters from Dehradun-Rishikesh 4-Lane State Highway.<br/>Vastu compliant with 20 ft wide road access.
          </p>
          ...
          <div className="flex flex-wrap gap-12 items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-bold text-sm">480 Gaj</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-bold text-sm">20 ft Wide</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-bold text-sm">North - West</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full max-w-[1400px] mx-auto px-6 py-16 bg-[#f8f9fa]">
          ...
          <div className="relative h-[420px] rounded-2xl overflow-hidden group shadow-md">
            <Image src="/ranipokhri_new_gal_main.png" alt="Property View" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/ranipokhri_new_gal_1.png" alt="Property View 1" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/ranipokhri_new_gal_2.png" alt="Property View 2" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/ranipokhri_new_gal_3.jpg" alt="Property View 3" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/ranipokhri_new_gal_4.jpg" alt="Property View 4" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
          </div>
        </div></section>
      ...
      <section className="w-full max-w-[1400px] mx-auto px-6 pb-16 pt-8 bg-[#f8f9fa]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {[
            ...
            { icon: Crosshair, title: "Vastu Compliant", desc: "Plot is vastu compliant ensuring positivity and prosperity." },
            { icon: Building2, title: "Wide Road Access", desc: "20 ft wide internal road for smooth connectivity." },
      ...
      <section className="w-full max-w-[1400px] mx-auto px-6 py-16 bg-[#f8f9fa]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-10 divide-x divide-gray-200">
          {[
            ...
            { icon: BriefcaseBusiness, title: "Hospital", dist: "10 mins drive" }, // using a bag/briefcase for hospital as per mockup (it has a med bag icon)
          ].map((item, i) => (
