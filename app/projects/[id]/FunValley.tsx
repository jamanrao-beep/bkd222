...
import {
  ...
  Crosshair, Spline, ArrowUp, BriefcaseBusiness, Phone, Shield, Grid, ShoppingBag
} from "lucide-react";
    ...
    <div className="w-full bg-[#f8f9fa] min-h-screen font-sans selection:bg-[#F7A300] selection:text-white">
      ...
      <section className="relative w-full h-[85vh] min-h-[600px] flex flex-col pt-[80px]">
        <div className="absolute inset-0 z-0 top-0">
          <Image
            src="/funvalley_new_thumbnail.jpg"
            alt="Fun Valley Plot"
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-8 md:px-16 max-w-[1400px] mx-auto w-full text-white">
          <div className="flex items-center gap-2 text-xs font-semibold mb-6">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-white">Fun Valley, Majigrant, Laltappar, Dehradun</span>
          </div>

          <h1 className="font-serif text-5xl md:text-[56px] font-bold leading-[1.1] mb-6 tracking-tight">
            Fun Valley,<br />Majigrant, Laltappar<br />
          ...
          <p className="text-gray-100 text-base max-w-[420px] leading-relaxed mb-12 font-medium">
            57 Bigha gated township with 100+ premium plots.<br/>Fully clear land with transparent paperwork.<br/>Ideal for residential &amp; future-focused investment.
          </p>
          ...
          <div className="flex flex-wrap gap-12 items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-bold text-sm">57 Bigha</p>
              </div>
            </div>
            
            <div className="flex items-center gap-4">
              <Grid size={36} strokeWidth={1.5} className="text-[#F7A300]" />
              <div>
                <p className="text-[11px] text-gray-300 font-bold uppercase tracking-wide mb-0.5">Plots</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-bold text-sm">Internal Roads</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full max-w-[1400px] mx-auto px-6 py-16 bg-[#f8f9fa]">
          ...
          <div className="relative h-[420px] rounded-2xl overflow-hidden group shadow-md">
            <Image src="/funvalley_new_gal_main.png" alt="Property View" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/funvalley_new_gal_1.png" alt="Property View 1" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/funvalley_new_gal_2.png" alt="Property View 2" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/funvalley_new_gal_3.png" alt="Property View 3" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative h-[202px] rounded-2xl overflow-hidden group shadow-sm">
              <Image src="/funvalley_new_gal_4.png" alt="Property View 4" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
          </div>
        </div></section>
      ...
      <section className="w-full max-w-[1400px] mx-auto px-6 pb-16 pt-8 bg-[#f8f9fa]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {[
            { icon: MapPin, title: "Prime Location", desc: "Situated on Haridwar Highway, Majigrant, Laltappar - a fast developing corridor." },
            { icon: ShieldCheck, title: "Gated Township", desc: "Secure gated township with well-planned infrastructure and wide internal roads." },
            { icon: Grid, title: "100+ Premium Plots", desc: "57 Bigha land parcel with 100+ premium residential plots." },
            { icon: FileText, title: "Clear & Transparent", desc: "Fully clear land with transparent title and complete paperwork." },
            { icon: TrendingUp, title: "Future Growth Potential", desc: "Ideal for residential living and long-term high returns." },
          ].map((item, i) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-0 text-[13px]">
          <div className="space-y-0">
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              ...
              <span className="font-bold text-gray-900">57 Bigha</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
                <Grid size={20} className="text-[#F7A300]" strokeWidth={1.5} /> Plots
              </div>
            ...
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              ...
              <span className="font-bold text-gray-900">Fun Valley, Majigrant, Laltappar, Dehradun</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
                <Navigation size={20} className="text-[#F7A300]" strokeWidth={1.5} /> Highway
              </div>
              <span className="font-bold text-gray-900">Haridwar Highway</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
                <Building2 size={20} className="text-[#F7A300]" strokeWidth={1.5} /> Road Access
              </div>
              <span className="font-bold text-gray-900">Internal Roads</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
                <Compass size={20} className="text-[#F7A300]" strokeWidth={1.5} /> Distance from Highway
              </div>
          ...
          <div className="space-y-0 mt-0">
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              ...
              <span className="font-bold text-gray-900 text-right">Residential Plots</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
            ...
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
                <Shield size={20} className="text-[#F7A300]" strokeWidth={1.5} /> Land Status
              </div>
              <span className="font-bold text-gray-900">Fully Clear</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
                <FileText size={20} className="text-[#F7A300]" strokeWidth={1.5} /> Documentation
              </div>
              <span className="font-bold text-gray-900">100% Clear &amp; Transparent</span>
            </div>
            <div className="flex items-center justify-between border-b border-gray-200 py-4">
              <div className="flex items-center gap-4 text-gray-600 font-semibold">
                <IndianRupee size={20} className="text-[#F7A300]" strokeWidth={1.5} /> Rate
              </div>
              <span className="font-bold text-gray-900">₹28,000+ / Sq. Yard</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full max-w-[1400px] mx-auto px-6 py-16 bg-[#f8f9fa]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-y-10 divide-x divide-gray-200">
          {[
            { icon: Navigation, title: "Haridwar Highway", dist: "Adjacent" },
            { icon: Building, title: "Dehradun City", dist: "25 mins drive" },
            { icon: Plane, title: "Jolly Grant Airport", dist: "35 mins drive" },
            { icon: Train, title: "Railway Station", dist: "20 mins drive" },
            { icon: GraduationCap, title: "School & College", dist: "10-15 mins" },
            { icon: BriefcaseBusiness, title: "Hospital", dist: "10 mins drive" },
            { icon: ShoppingBag, title: "Shopping & Market", dist: "5 mins drive" },
          ].map((item, i) => (
      ...
      <section className="w-full bg-[#0a0a0a] py-20 px-6 mt-8 rounded-t-3xl border-t-4 border-[#F7A300]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 divide-y lg:divide-y-0 lg:divide-x divide-white/10">
            {[
              { icon: TrendingUp, title: "High Appreciation", desc: "Located in a high growth corridor with excellent future appreciation potential." },
              { icon: ShieldCheck, title: "Safe Investment", desc: "Secure gated township with clear titles and legal documentation." },
              { icon: HardHat, title: "Excellent Infrastructure", desc: "Wide internal roads, drainage, electricity and modern infrastructure." },
              { icon: Users, title: "Ideal for Living", desc: "Peaceful environment with all essential amenities nearby for comfortable living." },
              { icon: IndianRupee, title: "Great Returns", desc: "Perfect for long-term investment with high rental yield and capital growth." },
            ].map((item, i) => (
              <div key={i} className={`flex flex-col items-center text-center px-6 ${i !== 0 ? 'pt-8 lg:pt-0' : ''}`}>
                ...
                <p className="text-gray-400 text-[11px] leading-relaxed max-w-[200px]">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
