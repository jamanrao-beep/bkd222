          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <Link href="/properties" className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.06)] border border-gray-100 block group flex flex-col hover:-translate-y-1 transition-transform duration-300">
              <div className="relative h-56 w-full">
                <Image src="/ranipokhri_thumbnail.jpg" alt="Ranipokhari Plot" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover" />
              </div>
            ...
            <Link href="/properties" className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.06)] border border-gray-100 block group flex flex-col hover:-translate-y-1 transition-transform duration-300">
              <div className="relative h-56 w-full">
                <Image src="/thano_thumbnail.jpg" alt="Thano Plot" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover" />
              </div>
              <div className="p-6 flex flex-col flex-grow">
      ...
      <section className="bg-[#2c3138] border-t border-white/5 py-10">
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4">
            <Link href="tel:+919058571709" className="bg-[#F7A300] text-black px-6 py-3 rounded text-sm font-bold flex items-center gap-2 hover:bg-[#e59800] transition-colors">
              <Phone size={16} fill="black" /> Call Now
            </Link>
            <Link href="https://wa.me/919058571709" target="_blank" rel="noopener noreferrer" className="bg-transparent border border-white/30 text-white px-6 py-3 rounded text-sm font-bold flex items-center gap-2 hover:bg-white/10 transition-colors">
      ...
      <footer className="bg-[#0a0a0a] text-gray-400 pt-16 pb-8 text-[13px]">
        <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <p className="mb-6 leading-relaxed max-w-sm md:max-w-none">
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <ul className="space-y-3 mb-8 font-medium flex flex-col items-center md:items-start">
              <li className="flex items-center justify-center md:justify-start gap-3">
                <Phone size={14} className="text-[#F7A300] shrink-0" />
                <a href="tel:+919058571709" className="hover:text-[#F7A300] transition-colors">+91 90585 71709</a>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-3">
                <Mail size={14} className="text-[#F7A300] shrink-0" />
